...
import { FaLinkedin, FaTwitter , FaGithub, FaInstagram, FaFacebook , FaEnvelope , FaPhone , FaClock , FaMapMarkerAlt  } from "react-icons/fa";
...
const Contact = () => {
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
    ...
    <div className="space-y-6">
      <h3 className="text-2xl font-bold text-purple-400">Quick Links</h3>
      <ul className="space-y-3">
        <li><a href="#about" className="text-gray-300 hover:text-purple-400 transition">About Me</a></li>
        <li><a href="#services" className="text-gray-300 hover:text-purple-400 transition">Services</a></li>
        <li><a href="#projects" className="text-gray-300 hover:text-purple-400 transition">Projects</a></li>
        <li><a href="#testimonials" className="text-gray-300 hover:text-purple-400 transition">Testimonials</a></li>
      </ul>
    </div> */}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          ...
          className={`w-full px-6 py-3 font-semibold rounded-md transition-all ${
            isSubmitting ? "bg-gray-600" : "bg-purple-600 hover:bg-purple-700"
          }`}
          disabled={isSubmitting}
        >
